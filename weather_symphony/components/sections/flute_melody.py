...
class FluteMelody(MelodySection):
    def __init__(self, *args):
        ...
        self.rhythm_settings = {
            Scene.BROKEN_GUSTY: (0.3, 8, 0.4, 0.5),
            Scene.SCATTERED_WINDY: (0.3, 8, 0.4, 0.1),
            Scene.CLEAR_BROILING: (0.7, 4, 0.15, 0.5),
            Scene.CLEAR_NICE: (0.8, 8, 0.4, 0.4),
            Scene.NIGHT_CHILLY: (0.6, 16, 0.3, 0.2),
            Scene.NIGHT_WARM: (0.3, 4, 0.5, 0.2),
        }
        self.scene_vel_add = {}
