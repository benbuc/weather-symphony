...
class StringsSection(HarmonySection):
    def __init__(self, *args):
        ...
        self.rhythm_settings_arpeggios = {
            Scene.OVERCAST_THUNDERSTORM: (16, 0.8, 0.9, 0.05),
            Scene.OVERCAST_WINDY: (16, 0.8, 0.75, 0.1),
            Scene.BROKEN_RAINY: (8, 0.6, 0.4, 0.3),
            Scene.BROKEN_GUSTY: (16, 0.9, 0.4, 0.3),
            Scene.SCATTERED_WINDY: (16, 0.9, 0.4, 0.2),
            Scene.CLEAR_BROILING: (4, 0.0, 0.3, 0.4),
            Scene.CLEAR_NICE: (4, 0.0, 0.5, 0.3),
            Scene.NIGHT_CHILLY: (8, 0.7, 0.5, 0.3),
            Scene.NIGHT_WARM: (8, 0.8, 0.4, 0.3),
        }
        self.rhythm_settings_chords = {
            Scene.OVERCAST_THUNDERSTORM: (4, 0.0, 0.7, 0),
            Scene.OVERCAST_WINDY: (4, 0.0, 0.5, 0.1),
            Scene.BROKEN_RAINY: (4, 0.0, 0.5, 0.1),
            Scene.BROKEN_GUSTY: (4, 0.0, 0.5, 0.1),
            Scene.SCATTERED_WINDY: (4, 0.0, 0.5, 0.1),
            Scene.CLEAR_BROILING: (1, 0.0, 0.3, 0),
            Scene.CLEAR_NICE: (2, 0.0, 0.5, 0.05),
            Scene.NIGHT_CHILLY: (4, 0.0, 0.5, 0.2),
            Scene.NIGHT_WARM: (2, 0.0, 0.5, 0.2),
        }
