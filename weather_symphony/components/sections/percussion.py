...
class PercussionSection(HarmonySection):
    def __init__(self, *args):
        ...
        self.rhythm_settings_arpeggios = {
            Scene.OVERCAST_THUNDERSTORM: (16, 1.0, 0.7, 0),
            Scene.OVERCAST_WINDY: (16, 0.8, 0.3, 0),
            Scene.BROKEN_RAINY: (0, 0.0, 0.0, 0),
            Scene.BROKEN_GUSTY: (8, 0.9, 0.2, 0),
            Scene.SCATTERED_WINDY: (8, 0.9, 0.2, 0),
            Scene.SCATTERED_SWELTRY: (1, 1.0, 0.3, 0),
            Scene.CLEAR_BROILING: (0, 0.0, 0.0, 0),
