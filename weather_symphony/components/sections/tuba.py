...
class TubaSection(HarmonySection):
    def __init__(self, *args):
        ...
        self.rhythm_settings_arpeggios = {
            Scene.OVERCAST_THUNDERSTORM: (16, 0.9, 0.4, 0.15),
            Scene.OVERCAST_WINDY: (16, 0.9, 0.2, 0.15),
            Scene.BROKEN_RAINY: (8, 0.6, 0.3, 0.1),
            ...
            Scene.NIGHT_CHILLY: (8, 0.3, 0.5, 0),
        ...
        self.rhythm_settings_chords = {
            ...
            Scene.BROKEN_GUSTY: (2, 0.0, 0.5, 0.2),
            Scene.SCATTERED_WINDY: (16, 0.5, 0.3, 0.1),
            ...
            Scene.NIGHT_WARM: (4, 0.0, 0.5, 0.1),
        }
